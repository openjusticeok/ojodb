...
OSCN data are scraped from [OSCN](http://www.oscn.net) using the `ojo` R package.
...
![oscn_caseinfo variables](images/oscn_caseinfo.png)
...
![oscn_atts variables](images/oscn_atts.png)
...
![oscn_citation variables](images/oscn_citations_one.png)
![oscn_citation variables](images/oscn_citations_two.png)
...
![oscn_civ_disp variables](images/oscn_civ_disps_one.png)
![oscn_civ_disp variables](images/oscn_civ_disps_two.png)
...
![oscn_crim_disp variables](images/oscn_crim_disps_one.png)

![oscn_crim_disp variables](images/oscn_crim_disps_two.png)
...
![oscn_events variables](images/oscn_events.png)
...
![oscn_mins variables](images/oscn_mins.png)
...
![oscn_party variables](images/oscn_party.png)
...
![oscn_party_names variables](images/oscn_party_names.png)
...
![oscn_party_address variables](images/oscn_party_address.png)
...
![oscn_party_profile variables](images/oscn_party_profile.png)
